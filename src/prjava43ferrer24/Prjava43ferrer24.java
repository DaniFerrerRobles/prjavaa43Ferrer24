package prjava43ferrer24; 
import java.awt.*;        // using AWT containers and components 
import java.awt.event.*;  // using AWT events and listener interfaces 
import java.net.*;
 
// An AWT GUI program inherits the top-level container java.awt.Frame 
public class Prjava43ferrer24 extends Frame 
   ...
   public Prjava43ferrer24 () { 
      ...
      setTitle("Nova finestra prjava43ferrer24");  // "this" Frame sets title 
   ...
   public static void main(String[] args) { 
      new Prjava43ferrer24();  // Let the construct do the job 
   } 
